...
const securityHeaders = {
  ...
  "Content-Security-Policy": [
    "default-src 'self'",
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://va.vercel-scripts.com https://app.cal.com https://cal.com",
    "style-src 'self' 'unsafe-inline' https://app.cal.com https://cal.com",
    "img-src 'self' data: blob: https:",
    "font-src 'self' data: https://app.cal.com https://cal.com",
    "connect-src 'self' https://*.supabase.co https://va.vercel-scripts.com https://app.cal.com https://cal.com https://api.cal.com",
